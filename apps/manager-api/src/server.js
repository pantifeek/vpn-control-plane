...
function getRuntimeEnv(profile) {
  ...
  if (process.env.RUNTIME_IPSEC_KEEPALIVE_ENABLED) {
    env.push(`RUNTIME_IPSEC_KEEPALIVE_ENABLED=${process.env.RUNTIME_IPSEC_KEEPALIVE_ENABLED}`);
  }
  if (process.env.RUNTIME_IPSEC_KEEPALIVE_INTERVAL_MS) {
    env.push(`RUNTIME_IPSEC_KEEPALIVE_INTERVAL_MS=${process.env.RUNTIME_IPSEC_KEEPALIVE_INTERVAL_MS}`);
  }
  if (process.env.RUNTIME_IPSEC_KEEPALIVE_TIMEOUT_MS) {
    env.push(`RUNTIME_IPSEC_KEEPALIVE_TIMEOUT_MS=${process.env.RUNTIME_IPSEC_KEEPALIVE_TIMEOUT_MS}`);
  }
